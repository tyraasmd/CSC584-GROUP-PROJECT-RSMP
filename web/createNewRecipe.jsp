...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="submitRecipe" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="file" id="recipeImage" name="recipe_image" accept="image/*" onchange="previewImage(event)" required>
                </div>
